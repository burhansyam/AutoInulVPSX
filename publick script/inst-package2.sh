...
#tambah akun Vmess
wget -O /usr/local/bin/add-vmess-user "https://raw.githubusercontent.com/hidessh99/Package-tambahan-Seller/main/publick%20script/add-vmess2.sh" && chmod +x /usr/local/bin/add-vmess-user
#tambah Akun Trojan
wget -O /usr/local/bin/add-trojan-user "https://raw.githubusercontent.com/hidessh99/Package-tambahan-Seller/main/publick%20script/add-trojan2.sh" && chmod +x /usr/local/bin/add-trojan-user
