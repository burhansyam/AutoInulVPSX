...
trojanlink1="trojan://${user}@${domain}:${tr}?mode=gun&security=tls&type=grpc&serviceName=akrab&sni=dl.google.com#Akrab_${user}"
trojanlink="trojan://${user}@${domain}:${tr}?path=%2Fbro&security=tls&host=${domain}&type=ws&sni=dl.google.com#TJWS_${user}"
clear
...
echo -e "Path : /bro" | tee -a /etc/log-create-user.log
echo -e "ServiceName : akrab" | tee -a /etc/log-create-user.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
